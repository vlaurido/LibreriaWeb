...
namespace LibreriaWeb.Controllers
{
    public class LibrosController : Controller
    {
        ...
        {
            var appDbContext = _context.Libros.Include(l => l.Autor);
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,AnioPublicacion,AutorId")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,AnioPublicacion,AutorId")] Libro libro)
        {
            if (id != libro.Id)
            {
                return NotFound();
